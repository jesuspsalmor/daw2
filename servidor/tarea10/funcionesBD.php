...
function insertarCliente($nombre, $apellido1, $apellido2, $dni, $fecha_nacimiento, $email) {
    if (!esAdmin()) {
        echo "Acceso denegado. Solo el administrador puede insertar clientes.";
        return;
    }
...
function actualizarCliente($id, $nombre, $apellido1, $apellido2, $dni, $fecha_nacimiento, $email) {
    if (!estaLogueado()) {
        echo "Acceso denegado. Debe estar logueado para actualizar clientes.";
        return;
    }
...
function borrarCliente($id) {
    if (!esAdmin()) {
        echo "Acceso denegado. Solo el administrador puede borrar clientes.";
        return;
    }
